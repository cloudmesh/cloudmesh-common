...
def install_chocolatey():
    ...
    try:
        ...
        chocolatey_install_command = 'powershell -Command "Set-ExecutionPolicy Bypass -Scope Process -Force; iex ((New-Object System.Net.WebClient).DownloadString(\'https://chocolatey.org/install.ps1\'))"'

        # Run the Chocolatey installation command using subprocess and capture output
        completed_process = subprocess.run(chocolatey_install_command, shell=True, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
